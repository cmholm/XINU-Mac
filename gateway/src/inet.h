 ...
 *  May be used but not sold without permission.
 *
 *  $Header: /usr/fp/src/fps/ram.udp/RCS/inet.h,v 1.13 86/02/21 20:40:13 tim Rel $
 */
...
#define		ICMP_REDIR_TOSNET	2		/* for tos and net */
...
struct udp {
	...
	u_short	dst;			/* destination port */
	short	length;			/* udp length */
